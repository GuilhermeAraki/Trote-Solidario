function calcular() {
    ...
    let mascote, homenagem, leite, kit, suplemento, caracter, arroz5kg, arroz1kg, feijao2kg, feijao1kg, macarrao, oleo, sangue, acao, contArre, contAcao, soma, equipe
    ...
    soma = mascote + homenagem + (2 * leite) + (arroz5kg * 5) + arroz1kg + (feijao2kg * 2) + feijao1kg + (macarrao / 2) + oleo + acao + contAcao + contArre
